...
export type HandleToolFunction<Schema extends StandardSchemaV1 | undefined> = (payload: ToolPayload<Schema>) => MaybePromise<any>;
...
export class Tool<Schema extends StandardSchemaV1 | undefined = StandardSchemaV1 | undefined, H extends HandleToolFunction<Schema> = any> {
	...
	'~call' = async (input: Schema extends StandardSchemaV1 ? StandardSchemaV1.InferInput<Schema> : undefined, sessionId?: string) => {
		try {
