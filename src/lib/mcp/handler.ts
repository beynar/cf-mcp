import { MaybePromise, MCPServer } from '../types';
...
export class MCPHandler {
	...
	constructor(server: MCPServer, private sessionId: string) {
		this.server = server;
		...
		return {
			...
			resources: {
				...
				read: async (payload) => {
					...
					const [result, type] = await resource['~call'](payload.uri, this.sessionId);
